m4_define(`_FW_DO_NOT_EDIT_',`@! GENERATED FILE, DO NOT EDIT!')m4_dnl
m4_dnl
...
m4_dnl
m4_dnl # Define
m4_define(`_FWDEF_',`@$_FWN_($1)')m4_dnl
m4_define(`_FWDef_',`_FWDEF_($1)@{$2@}')m4_dnl
m4_define(`_FWDefine_',`_FWDEF_($1)==@{$2@}')m4_dnl
